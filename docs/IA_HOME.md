...
| 2 | What you get | Print (incl. document split) · mail piece (addressed, stuffed envelope or postcard) · postage, then handoff to USPS. Tracing, logo envelope, NCOA, tracking live on `/features`. Approve stays in the lead and how-it-works. No MCP on home. |
