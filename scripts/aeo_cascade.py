...
INDUSTRIES = [
    ...
    },
    {
        ...
        "desc": "Legal notices and correspondence. You upload. You approve the proof. We print, apply postage, and hand off to USPS. Certified when you need proof.",
        ...
        "types": [
            ...
            ("badge-check", "Certified Mail / Certificate of Mailing", "Add proof options before you approve. You approve the proof."),
            ("users", "Human approval", "Nothing produces until someone confirms the proof. No silent auto-mail."),
            ("shield", "Not legal advice", "We print and deliver mail to USPS. You approve the proof."),
        ],
    ...
    },
    {
        ...
        "types": [
            ...
            ("badge-check", "Certified when you need proof", "Add Certified Mail before you approve. You approve the proof."),
